...
public class Taunt implements Ability{
    ...
    public void run(Player p, LivingEntity entity, double damage) {
        ...
        p.sendMessage(ChatColor.RED + "[" + entity.getCustomName() + ChatColor.RED + "] " + ChatColor.RESET + list.get(number));
    }
}